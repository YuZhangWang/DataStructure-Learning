...
CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.obj: CMakeFiles/10Inserting-a-node-at-beginning.dir/flags.make
CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.obj: ../11Insert-a-node-at-any-given-position.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir="D:\Code\C&C++\78DataStructure\cmake-build-debug\CMakeFiles" --progress-num=$(CMAKE_PROGRESS_2) "Building C object CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.obj"
	D:\CodeEnvironment\MinGW\bin\gcc.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles\10Inserting-a-node-at-beginning.dir\11Insert-a-node-at-any-given-position.c.obj -c "D:\Code\C&C++\78DataStructure\11Insert-a-node-at-any-given-position.c"

CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.i: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Preprocessing C source to CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.i"
	D:\CodeEnvironment\MinGW\bin\gcc.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E "D:\Code\C&C++\78DataStructure\11Insert-a-node-at-any-given-position.c" > CMakeFiles\10Inserting-a-node-at-beginning.dir\11Insert-a-node-at-any-given-position.c.i

CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.s: cmake_force
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green "Compiling C source to assembly CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.s"
	D:\CodeEnvironment\MinGW\bin\gcc.exe $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S "D:\Code\C&C++\78DataStructure\11Insert-a-node-at-any-given-position.c" -o CMakeFiles\10Inserting-a-node-at-beginning.dir\11Insert-a-node-at-any-given-position.c.s
...
10Inserting-a-node-at-beginning.exe: CMakeFiles/10Inserting-a-node-at-beginning.dir/11Insert-a-node-at-any-given-position.c.obj
...
10Inserting-a-node-at-beginning.exe: CMakeFiles/10Inserting-a-node-at-beginning.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir="D:\Code\C&C++\78DataStructure\cmake-build-debug\CMakeFiles" --progress-num=$(CMAKE_PROGRESS_3) "Linking C executable 10Inserting-a-node-at-beginning.exe"
